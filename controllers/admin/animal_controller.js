...
exports.webanimals = async (req, res) => {
    ...
    try {
        ...
        const results = animals.map(animal => ({
            ...
            image: animal.image ? `${baseUrl}/v1/mob/image/animal/${animal.image}` : `${baseUrl}/v1/mob/image/default/picture.png`,
            amount: animal.amount,
            id_user: animal.user.id_user,
            name: animal.user.name,
            email: animal.user.email,
            user_picture: animal.user.picture ? `${baseUrl}/v1/mob/image/profile/${animal.user.picture}` : `${baseUrl}/v1/mob/image/default/picture.png`,
